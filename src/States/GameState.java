...
/**Clase donde ocurre toda la interaccion del juego*/
public final class GameState extends State{
    ...
    /** metodo que inicializa todos los componentes de juego*/
    @Override
    public void onEnter() {
            sonidos = new Sonido();
            sonidos.mOtor();
    ...
    public void comenzar(){
        ...
        desplazamiento = new Timer(50, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    p.AumentarPosicion(aceleracion);
                }
    ...
    /** genera los tanques de combustible */
    ...
    protected void paintComponent(Graphics g) {
        ...
        {
            g.drawImage(avioneta.getImagen(),avioneta.getX(),avioneta.getY(), this);
        }
