...
public class Avioneta {
    ...
    public void generar(){
        ...
        if(generar)
        {
            ...
            {
                try {
                  imagen = ImageIO.read(new File("src/Nave/Nave2.png"));
                  } catch (IOException ex) {
                      System.out.println("error la imagen de la nave no se encuentra en la ruta");
                  }
                enemigo = 1;
                ubicacion.x=1100;
                ubicacion.y=var;
            ...
            {
                try {
                imagen = ImageIO.read(new File("src/Nave/Nave1.png"));
                  } catch (IOException ex) {
    ...
    public void explotar(){
        try {
           imagen = ImageIO.read(new File("src/Explosion/Explosion.png"));
        } catch (IOException ex) {
            System.out.println("error la imagen de la explosion no se encuentra en la ruta");
        }
        ini=true;
    }
